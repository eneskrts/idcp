...
class Availability(BaseModel):
    ...
    available_user = models.ForeignKey(get_user_model(), on_delete=models.DO_NOTHING, related_name='available_user',null=False)
...
class MeetingRoom(BaseModel):
    ...
    meeting_status = models.CharField(choices=StatusOption.choices, default=StatusOption.ACTIVE, null=False, max_length=20)
...
class AppointmentRequest(BaseModel):
    meeting = models.ForeignKey(to="appointment.MeetingRoom",on_delete=models.CASCADE, related_name="meeting_room")
